...
class pcd_generator{
    ...
    private:
         ...
         */
        void load_image(const cv::Mat& RGB_img,const cv::Mat& dep_img, MatrixXf_row semantic,\
                        frame* ptr_fr);

        void load_map(frame* ptr_fr, const bool* mask);
    ...
    public:
        ...
        void read_pcd_from_file(std::string filename, point_cloud* ptr_pcd);
