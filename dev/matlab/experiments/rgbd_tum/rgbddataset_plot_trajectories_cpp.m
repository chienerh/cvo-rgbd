...
%         H = H * result{i}.T';
%     end
    R = reshape(result(i,6:end),3,3)';
    t = result(i,3:5)';
    H1 = [R, t; 0 0 0 1];
%     H1 = tfinv(H1);
    H = H * H1;
    position_rkhs.x(i+1,1) = H(1,4);
    position_rkhs.y(i+1,1) = H(2,4);
    position_rkhs.z(i+1,1) = H(3,4);
end
...
% title('fr1-desk', 'FontWeight', 'normal', 'fontsize', fsize), grid on, axis auto equal
figuresize(21,21,'cm')
print -opengl -dpng -r300 tum_top_fr1-desk_gradient_50_10000_0.03.png
